...
class FAQ extends Component<{}, FAQState> {
    state: FAQState = {
        openIndex: null,
    };
        ...
        const questions: QuestionProps[] = [
            {
                ...
                answer:
                    "Rush is a week long event where Theta Tau showcases what we have to offer as an organization and what we could offer you! It’s a chance to get to know Theta Tau and its members better and see if it is the right fit for you!",
            },
            {
                question: "Why should I rush? What does Theta Tau offer?",
                answer:
                    "Theta Tau is focused on providing a supportive environment for engineering students, offering professional development, academic support, and a community of like-minded individuals. By joining, you’ll be part of a brotherhood filled with peers and alumni ready to offer mentorship and share in both the challenges and triumphs during and after your college career. If you’re aiming to enhance your leadership abilities, build connections, or find your place in a larger community, you should come out to rush Theta Tau!",
            },
            {
                question: "Who is eligible to Rush?",
                answer:
                    "Anyone can come out to Rush, but you must be an engineering, computer science, or data science major to join. We also require a cumulative 2.0 GPA to join the fraternity and have ~$200 payments every two quarters (biannual).",
            },
            {
                question: "How do I prepare for Rush?",
                answer: "Come with an open mind and be ready to meet lots of people– not just actives, but fellow rushees too! We recommend preparing your resume and updating your LinkedIn before ProDev night, so you can get the best experience possible. Also, it might get cold, since rush can last a while- be sure to bring a jacket!"
            },
            {
                question: "I don't have professional clothes, is that okay?",
                answer:
                    "Dress code is encouraged but not required. Wear what you can, don’t feel pressured.",
            },
            {
                question: "What is After Hours?",
                answer:
                    "After Hours is the time period from when the event ends (around 9 pm) until midnight. After Hours is not required, but encouraged so you can spend more time getting to know the brothers, their experience in Theta Tau, and building an overall stronger connection.",
            },
            {
                question: "What happens if I can't attend all the events or am not on time?",
                answer:
                    "While attending all events is often encouraged to fully engage with the fraternity and its members, it's understood that conflicts can occur. It's okay if you can't attend a specific event, but coming out (even if late) ultimately benefits you in building those connections and helps in potentially receiving an invite to join Theta Tau. However, it is not required to attend every open event to receive an invite.",
            },
            {
                question: "What if I have more questions?",
                answer: "That is the perfect reason to come out to our Rush events! Ask the brothers of Theta Tau any and all of your questions or contact one of our Rush Directors! You can reach out via email (ucithetatau@gmail.com) or Instagram (@thetatauuci)"
            }
        ];
...
class Question extends Component<QuestionComponentProps> {
    render() {
        const { question, answer, isOpen, onClick } = this.props;
        return (
            <div className="question">
                <button className="question-title" onClick={onClick}>
