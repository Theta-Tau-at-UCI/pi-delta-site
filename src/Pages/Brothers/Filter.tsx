  ...
  return (
    <div className="filter-container">
      ...
      >
        ...
        <DropdownItem
            className={activeFilter === 27 ? "active" : ""}
            onClick={() => setActiveFilter(27)}
        >
          Delta Beta
        </DropdownItem>
        <DropdownItem
            className={activeFilter === 28 ? "active" : ""}
            onClick={() => setActiveFilter(28)}
        >
          Epsilon Beta
        </DropdownItem>
        <DropdownItem
        ...
        <DropdownItem
            className={activeFilter === 30 ? "active" : ""}
            onClick={() => setActiveFilter(30)}
        >
          Eta Beta
        </DropdownItem>
        <DropdownItem
            className={activeFilter === 31 ? "active" : ""}
