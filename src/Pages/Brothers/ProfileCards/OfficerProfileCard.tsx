...
export default class OfficerProfileCard extends React.Component<{id: number, name: string, class: string, linkedin_url: string, major: string, cabby_exec_position: string | undefined , profile_url:string, casual_photo: string, blurb: string}, {isOpen: boolean}> {
